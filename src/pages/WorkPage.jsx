...
const WORK_ITEMS = [
  {
    ...
    subtitle: 'Live Industry Project · TradeArth',
    problem: 'Indian financial markets lacked accessible NLP-driven strategy tools for retail investors.',
    approach: 'Architected an NLP-to-strategy translation pipeline for TradeArth — data ingestion, NLP analysis, signal output — as a live industry engagement. Presented the project to the entire IT department at KBT College, sharing how the project was secured and its industry impact.',
    impact: 'Received Pre-Placement Offer (PPO) from TradeArth. End-to-end production system — business impact over academic theory.',
    photo: '/assets/images/achievements/Photo of me presenting Project in front of whole IT department students.jpg',
    photoCaption: 'Presenting the TradeArth project to IT department students',
  ...
  },
  {
    ...
    approach: 'Presented the TradeArth Algorithmic Strategy Builder project to the entire IT department student body. Shared the process of securing a live industry project, the challenges faced, technical decisions made, and the impact it had on our team.',
    impact: 'Inspired peers to pursue industry projects. Demonstrated how engineering work translates to real business impact. Received PPO from TradeArth following the engagement.',
    photo: '/assets/images/achievements/Participation in Smart India Hackathon.jpg',
    photoCaption: 'Smart India Hackathon — engineering problem solving',
  ...
  return (
    <main style={{ minHeight: '100vh', paddingTop: '6rem' }}>
      ...
      <section style={{ borderTop: '1px solid rgba(255,255,255,0.06)', background: '#0c0c0c', padding: 'clamp(4rem,8vw,7rem) clamp(1.25rem,5vw,5rem)' }}>
        <div style={{ maxWidth: '1320px', margin: '0 auto' }}>
          <p style={{ fontSize: '0.65rem', letterSpacing: '0.18em', textTransform: 'uppercase', color: S.gold, fontWeight: 600, marginBottom: '1rem' }}>Research</p>
          ...
          {[
            ...
            <div key={paper.num} style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: 'clamp(1.5rem,2.5vw,2.5rem) 0', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px,1fr))', gap: 'clamp(2rem,4vw,4rem)', alignItems: 'center' }}>
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
                  <span style={{ fontFamily: S.serif, fontSize: '0.9rem', color: S.muted, opacity: 0.5 }}>{paper.num}</span>
                  <span style={{ fontSize: '0.6rem', letterSpacing: '0.14em', textTransform: 'uppercase', color: S.gold, border: '1px solid rgba(201,168,76,0.25)', padding: '0.25rem 0.75rem', borderRadius: '3rem' }}>{paper.type}</span>
                </div>
