...
export default function Research() {
  ...
  return (
    <section ref={ref} id="research" className="px-6 py-16 md:px-12 md:py-28" style={{ borderTop: `1px solid ${S.border}` }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>

        {/* Header */}
        <div className="res-reveal" style={{ marginBottom: '3rem' }}>
          <p style={{ fontSize: '0.65rem', letterSpacing: '0.15em', textTransform: 'uppercase', color: S.gold, marginBottom: '1rem', fontWeight: 600 }}>Academic Contribution</p>
        ...
        <div className="res-reveal grid grid-cols-1 md:grid-cols-[1.1fr_1fr] gap-8 md:gap-16 items-start mb-12 md:mb-16">
          <div className="p-6 md:p-12" style={{ background: S.surface, border: `1px solid ${S.border}`, borderRadius: '1.5rem' }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-4 md:gap-6 mb-8 md:mb-10">
              {[
                ...
                <div key={m.label} style={{ paddingTop: '1rem', borderTop: `1px solid ${S.border}` }}>
                  <div style={{ fontSize: '0.55rem', textTransform: 'uppercase', letterSpacing: '0.12em', color: S.muted, marginBottom: '0.4rem' }}>{m.label}</div>
                  <div style={{ fontSize: '0.85rem', color: S.text, fontWeight: 500 }}>{m.value}</div>
                </div>
              ))}
            </div>
            <p style={{ color: S.muted, fontSize: 'clamp(0.85rem, 2vw, 0.9rem)', lineHeight: 1.7, fontWeight: 300, marginBottom: '2rem' }}>
        ...
        <div className="res-reveal" style={{ marginTop: '1.5rem' }}>
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6 items-center p-6 md:p-10" style={{
